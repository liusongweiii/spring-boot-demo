...
public class URLUtil {
    ...
    public static String sendGet(String url,boolean waitType) {
        String result = "";
     ...
     *  不等待返回结果
     */
    public static String sendGetNoRest(String url, String param) {
        url = url + "?" + param;
    ...
    public static String sendPost(String url,String param,boolean waitType) {
     ...
     * 不等待返回结果
     */
    public static String sendPostNoRest(String url, String param) {
        return sendPost(url,param,false);
    }

    private static String markValStr(Map<String,Object> map){
